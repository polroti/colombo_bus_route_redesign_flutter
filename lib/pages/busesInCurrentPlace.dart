...
class BusesInCurrentPlace extends StatefulWidget {
  BusesInCurrentPlace({Key key}) : super(key: key);

  @override
  _BusesInCurrentPlaceState createState() => _BusesInCurrentPlaceState();
}

class _BusesInCurrentPlaceState extends State<BusesInCurrentPlace> {
  String start;
  String end;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Buses in current place"),
        ),
        body: Column(
          children: [
            Visibility(
